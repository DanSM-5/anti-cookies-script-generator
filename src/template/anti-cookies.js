...
(() => {
  ...
  const max = /** @type {number} */("{{MAX}}"); // number of retries
  /** @ts-ignore It will be replaced by and actual number */
  const retryTime = /** @type {number} */ ("{{RETRY_TIME}}"); // in seconds
  /** @ts-ignore It will be replaced by and actual number */
  const cicles = /** @type {number} */ ("{{CICLES}}");
  /** @ts-ignore It will be replaced by and actual number */
  const initialDelay = /** @type {number} */ ("{{INITIAL_DELAY}}");
  /** @ts-ignore It will be replaced by and actual number */
  const loop = /** @type {boolean} */("{{LOOP}}");
  /** @type {(string|Element)[]} */
  const targets = [
